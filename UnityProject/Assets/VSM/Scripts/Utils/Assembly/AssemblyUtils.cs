...
public static class AssemblyUtils
{
    ...
    public static Type FindType(string typeName)
    {
        ...
        if (type == null)
        {
            AssemblyTypeDefinition typeDef = new AssemblyTypeDefinition(typeName);
    ...
    public static Type FindType(string typeName, string assemblyName)
    {
        ...
        return FindType(typeName, assemblyName);
    }
    ...
    {
        return ((AppDomain)AppDomain.CurrentDomain).GetAssemblies() as Assembly[];
    }
    ...
    static readonly Regex versionRegEx = new Regex(", Version=[^\\]]+", RegexOptions.None);
